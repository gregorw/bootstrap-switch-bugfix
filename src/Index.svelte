<main class="container-xxl py-4">
  ...
  <p>
    Who does not love <a href="https://getbootstrap.com/docs/5.3/forms/checks-radios/#switches" target="_blank">Bootstrap’s switches</a>?
    <br/>
    <a href="https://www.nngroup.com/articles/toggle-switch-guidelines/" target="_blank">Toggle Switches</a>  are an essential part of many applications.
  </p>
  ...
  <h3>Bigger Change</h3>
  <p>We may want the “switch” to adhere to <code>$border-radius</code> settings. This means that the toggle SVG (i.e. <code>$form-switch-bg-image</code>) would need to be adjusted accordingly. This could easily be achieved using the rect SVG attribute <code>rx</code>. But, this is certainly not required at the moment.</p>
